...
const index = () => {
  ...
  useEffect(() => {
    const fetchdata = async () => {
      try {
        const res = await axios.get("https://internshala-clone-backend-xzpg.onrender.com/api/application")
        setdata(res.data);
      } catch (error) {
        console.log(error);
      }
  ...
  const handleacceptandreject = async (id: any, action: any) => {
    try {
      const res = await axios.put(
        `https://internshala-clone-backend-xzpg.onrender.com/api/application/${id}`,
        { action }
      );
