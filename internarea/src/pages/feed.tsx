...
export default function FeedPage() {
  ...
  const fetchPosts = async () => {
    try {
      const res = await axios.get("https://internshala-clone-ciaz.onrender.com/api/post/all");
      setPosts(res.data);
    } catch (error) {
  ...
  const handleLike = async (postId: string) => {
    ...
    await axios.post(`https://internshala-clone-ciaz.onrender.com/api/post/like/${postId}`, {
      uid: currentUid,
    });
  ...
  const handleComment = async (postId: string) => {
    ...
    await axios.post(`https://internshala-clone-ciaz.onrender.com/api/post/comment/${postId}`, {
      uid: currentUid,
  ...
  const handleShare = async (postId: string) => {
    ...
    try {
      await axios.post(`https://internshala-clone-ciaz.onrender.com/api/post/share/${postId}`, {
        uid: currentUid,
      });
  ...
  const handleCreatePost = async () => {
    ...
    try {
      ...
      await axios.post("https://internshala-clone-ciaz.onrender.com/api/post/create", formData);
